...
const userLogin = {
  token:
    'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6InRlc3QiLCJpZCI6IjYzNTRmZWMxMzUwMmRhZWY4YzMyMzM5YyIsImlhdCI6MTY4NzAxNjc0Nn0.6GMjaA6upPgZlalrs8Bww09pRbVQRgbpIlrKRN86PKs',
  username: 'test',
  name: 'Test Name',
};
...
beforeEach(async () => {
  ...
  const user = new User({
    ...
    name: 'Test Name',
    passwordHash:
      '$2b$10$1fNmwel8hX8YsTIac78s6u0ks8xqyUIW.2cefU.hYVCkU6eIYstSG',
    notes: notesArr,
    __v: 0,
  });
  await user.save();
